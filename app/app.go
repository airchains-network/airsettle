...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		airsettlemodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	AirsettleKeeper airsettlemodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.AirsettleKeeper = *airsettlemodulekeeper.NewKeeper(
		appCodec,
		keys[airsettlemoduletypes.StoreKey],
		keys[airsettlemoduletypes.MemStoreKey],
		app.GetSubspace(airsettlemoduletypes.ModuleName),
	)
	airsettleModule := airsettlemodule.NewAppModule(appCodec, app.AirsettleKeeper, app.AccountKeeper, app.BankKeeper)
	...
	app.mm.SetOrderBeginBlockers(
		...
		airsettlemoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(airsettlemoduletypes.ModuleName)
